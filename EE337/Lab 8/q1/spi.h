...
void spi_init(void)
{
	...
	*/
	...
	//SPCON = 0;
	IEN1 |= 0x04;				// ESPI = 1 to enable spi interrupt IEN1 |= 0x04 (00000100)
	EA 	  = 1;					// Enable interrupts EA = 1; 
	SPCON = 0x7F;				// Enable spi module, SPR0= 0, SPEN = 1, SSDIS = 1, MSTR = 1, CPOL = 1, CPHA = 1, SPR1 = 1, SPR0 = 1
	//SPCON|= 0b01111111;		// Enable spi module, SPR0= 0, SPEN = 1, SSDIS = 1, MSTR = 1, CPOL = 1, CPHA = 1, SPR1 = 1, SPR0 = 1 (01111111)
